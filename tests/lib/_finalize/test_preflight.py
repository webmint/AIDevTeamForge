...
class TestPreflightContext(unittest.TestCase):
    ...
    def test_memory_excerpt_capped_at_default_excerpt_lines(self):
        ...
        # exercises a cap at all. Re-fixtured with a single real "## "
        ...
        # 1 heading + 1 marker + DEFAULT_EXCERPT_LINES content lines.
        self.assertEqual(len(lines), 2 + DEFAULT_EXCERPT_LINES)
        # Newest lines survive; earliest are the ones declared omitted.
