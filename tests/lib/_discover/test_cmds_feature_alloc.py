...
tests/lib/test_discover_helper.py (slug-only behaviour, no --ticket). This
file covers ONLY the new --ticket surface and does not duplicate that
file's slug-only cases.
