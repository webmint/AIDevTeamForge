...
# in src/devforge/lib/ (detect_report, wizard_render).
#
# Runtime helpers ride along: src/devforge/lib/{detect_report,wizard_render}{,.py}
# are the detection + (pending-retirement) wizard helpers; they land at
