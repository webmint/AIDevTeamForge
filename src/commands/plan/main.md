...
**Dead code declared**: [include this line ONLY if ≥1 row named: "[N] path(s) — MUST-delete, folded into the owning task at /breakdown"; omit the entire line when none]
