...
## The D7 bounce — when to stop and recommend /devforge:specify

STOP and recommend `/devforge:specify` when ANY working-list item is a feature/architecture change rather than a defect repair. Surface the bounce to the user naming:
