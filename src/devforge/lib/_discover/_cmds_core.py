...
def cmd_preflight(args: argparse.Namespace) -> int:
    """4-artefact hard gate + memory read. Exit 2 + BLOCKED message on missing.
    ...
    against above) -- identical to research_helper's sibling verb, and no
    second root convention is introduced here.
    ...
    memory_present + memory_excerpt. This verb (and research_helper's
    sibling) also emits memory_state because the downstream /discover
