"""argparse parser + all cmd_* handlers + main entry for discover_helper.

Imports state plumbing from ._state, validation/error from ._validators,
and topic/conflict/coverage logic from ._topic.
"""
